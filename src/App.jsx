...
const DBT_SKILLS=[
  {category:"마인드풀니스",emoji:"🧘",color:"#a8d8ea",skills:[
    {name:"지혜로운 마음",desc:"이성적 마음과 감정적 마음의 균형을 찾아 지혜로운 판단을 내립니다."},
    {name:"관찰하기",desc:"그저 알아차리기: 판단 없이 현재 순간의 경험을 있는 그대로 알아차리세요."},
    {name:"기술하기",desc:"말로 표현하기: 경험을 해석 없이 사실만을 언어로 기술하세요."},
    {name:"참여하기",desc:"경험 속으로 들어가기: 현재 활동에 완전히 몰입하세요."},
    {name:"무판단적 마음",desc:"자신과 타인을 평가하거나 판단하지 않는 태도를 연습하세요."},
    {name:"한가지 마음 갖기",desc:"순간에 몰입하기: 한 번에 하나의 일에만 집중하세요."},
    {name:"효과적인 것에 집중하기",desc:"목표를 달성하는 데 효과적인 것에 집중하세요."},
  ]},
  {category:"고통 감내",emoji:"🛡️",color:"#f4a7b9",skills:[
    {name:"위기 생존하기: STOP",desc:"Stop(멈추기), Take a step back(물러서기), Observe(관찰하기), Proceed mindfully(마음챙겨 나아가기)."},
    {name:"위기 생존하기: 장단점 비교하기",desc:"충동에 따르거나 참는 것의 장단점을 적어 현명한 선택을 합니다."},
    {name:"TIP",desc:"체온(Temperature), 격렬한 운동(Intense exercise), 조절된 호흡(Paced breathing)으로 강렬한 감정을 빠르게 낮춥니다."},
    {name:"주의 분산하기",desc:"Wise mind ACCEPTS: 활동, 기여, 비교, 감정, 밀어내기, 생각, 감각으로 주의를 전환합니다."},
    {name:"순간을 살리는 스킬",desc:"자기위안(5감 활용), 안전한 장소 상상하기, 의미 찾기 등으로 현재 순간을 견딥니다."},
    {name:"현실 수용하기: 철저한 수용",desc:"현실을 바꿀 수 없을 때 저항 대신 온전히 받아들이세요."},
    {name:"현실 수용하기: 살짝 미소 짓기",desc:"살짝 미소 짓기와 기꺼이 하는 손으로 현실을 부드럽게 수용합니다."},
    {name:"기꺼이 하기",desc:"고통스러운 상황에서도 효과적인 행동을 기꺼이 선택합니다."},
    {name:"현재 생각에 대한 마인드풀니스",desc:"생각을 사실로 받아들이지 않고 그냥 생각으로 알아차리세요."},
  ]},
  {category:"감정 조절",emoji:"💜",color:"#d4b8e0",skills:[
    {name:"사실 확인하기",desc:"감정을 촉발한 사건에 대한 해석이 사실인지 확인하세요."},
    {name:"감정에 정반대 행동하기",desc:"감정이 이끄는 충동과 반대되는 행동을 실천하세요."},
    {name:"문제 해결하기",desc:"감정을 유발한 문제를 직접 해결하는 행동을 취합니다."},
    {name:"긍정 감정 쌓기",desc:"Accumulated Positives: 즐거운 활동을 매일 실천하며 긍정 감정을 쌓습니다."},
    {name:"숙련감 쌓기",desc:"Built Mastery: 성취감을 느낄 수 있는 활동으로 자기효능감을 높입니다."},
    {name:"미리 대비하기",desc:"Coped Ahead: 어려운 상황을 미리 상상하며 대처 방법을 연습합니다."},
    {name:"유약성 줄이기",desc:"PLEASE: 신체건강, 식사, 수면, 운동, 약물 절제로 감정 취약성을 줄입니다."},
    {name:"현재 감정에 대한 마인드풀니스",desc:"현재 감정을 판단 없이 알아차리고 그냥 두는 연습을 합니다."},
  ]},
  {category:"대인관계 효율성",emoji:"🤝",color:"#b8e0c8",skills:[
    {name:"DEAR MAN",desc:"묘사, 표현, 주장, 강화, 마음챙김, 자신감, 협상으로 원하는 것을 요청합니다."},
    {name:"GIVE",desc:"부드럽게, 관심, 수인하기, 쉽게로 관계를 유지합니다."},
    {name:"FAST",desc:"공정하게, 사과 줄이기, 가치 고수, 정직하게로 자존감을 지킵니다."},
    {name:"중도의 길: 다이어렉틱스",desc:"상반되는 두 가지가 동시에 참일 수 있음을 인식하고 균형을 찾습니다."},
    {name:"중도의 길: 수인하기",desc:"자신과 타인의 감정·생각·행동이 이해 가능함을 인정합니다."},
    {name:"중도의 길: 행동변화 원칙",desc:"행동주의적 원칙(강화, 소거 등)을 활용해 건강한 행동 변화를 이끕니다."},
  ]},
];
